...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#828E64] font-sans px-4 py-8">
      <div className="bg-[#D0D9CD] p-6 sm:p-8 md:p-10 rounded-lg shadow-md w-full max-w-md text-center">
        <LogoHeader/>
        <h1 className="text-2xl sm:text-3xl font-bold text-green-800 mb-2">Nagpur Mandarin</h1>
        <h2 className="text-md sm:text-lg text-gray-700 mb-6 font-normal">Irrigation Scheduler</h2>
